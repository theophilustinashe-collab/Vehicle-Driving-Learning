      ...
      <aside className={cn(
        ...
        <div className="p-6 border-b border-sidebar-border flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-2 cursor-pointer">
            <div className="bg-sidebar-primary p-0 overflow-hidden rounded-md shadow-sm w-10 h-10 flex items-center justify-center">
      ...
      <main className="flex-1 overflow-y-auto bg-muted/30 relative flex flex-col h-full">
        ...
        <div className="lg:hidden sticky top-0 z-30 flex items-center justify-between p-4 bg-background/80 backdrop-blur-md border-b safe-top">
          <div className="flex items-center gap-2">
            ...
            <div className={cn("p-0 overflow-hidden rounded-md bg-primary/10 w-9 h-9 flex items-center justify-center", !isDashboard && "hidden sm:block")}>
